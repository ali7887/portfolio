    ...
    >
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="bg-white/50 backdrop-blur-sm rounded-xl p-6 md:p-8 border border-gray-200/50 shadow-sm hover:shadow-md hover:bg-white/80 transition-all duration-300"
        >
          <div className="grid md:grid-cols-2 gap-6 md:gap-8 lg:gap-10 items-center">
            ...
            <motion.div variants={fadeInUp} className="space-y-4 md:space-y-6">
              <div>
                ...
                <div className="h-1 w-20 bg-gradient-to-r from-accent-primary to-accent-neon rounded-full mb-4 md:mb-6" />
              </div>
              ...
              <div className="flex flex-wrap gap-3 md:gap-4 pt-4 md:pt-6">
                {PERSONAL_INFO.values.map((value, index) => (
                  <motion.span
                    ...
                    className="px-4 py-2 text-xs md:text-sm font-medium rounded-full bg-white/[0.08] text-accent-neon border border-accent-primary/30 hover:border-accent-neon/50 hover:bg-white/[0.12] transition-all"
                  >
                    {value}
                  </motion.span>
                ))}
